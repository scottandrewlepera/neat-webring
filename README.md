...
First, [download and unzip the latest ZIP file](https://github.com/scottandrewlepera/neat-webring/releases/latest) (you can usually just double-click on it and your computer should know what to do). This should create a folder named `neat-webring`
